...
namespace backend::lib {
    ...
    object minus(std::pmr::vector<std::unique_ptr<ast::tree>>&& args) noexcept {
        return std::stoll(args[0]->content.get_str_from_raw_string()) - std::stoll(args[1]->content.get_str_from_raw_string());
    }
    object mul(std::pmr::vector<std::unique_ptr<ast::tree>>&& args) noexcept {
        return std::stoll(args[0]->content.get_str_from_raw_string()) * std::stoll(args[1]->content.get_str_from_raw_string());
    }
    object div(std::pmr::vector<std::unique_ptr<ast::tree>>&& args) noexcept {
        return std::stoll(args[0]->content.get_str_from_raw_string()) / std::stoll(args[1]->content.get_str_from_raw_string());
    }
    object mod(std::pmr::vector<std::unique_ptr<ast::tree>>&& args) noexcept {
        return std::stoll(args[0]->content.get_str_from_raw_string()) % std::stoll(args[1]->content.get_str_from_raw_string());
    }
    object bit_and(std::pmr::vector<std::unique_ptr<ast::tree>>&& args) noexcept {
        return std::stoll(args[0]->content.get_str_from_raw_string()) & std::stoll(args[0]->content.get_str_from_raw_string());
    }
    object bit_or(std::pmr::vector<std::unique_ptr<ast::tree>>&& args) noexcept {
        return std::stoll(args[0]->content.get_str_from_raw_string()) | std::stoll(args[0]->content.get_str_from_raw_string());
    }
     ...
     */
    object nothing(std::pmr::vector<std::unique_ptr<ast::tree>>&& args) noexcept {
        if (args.empty()) {
            return "0"s;
        }
