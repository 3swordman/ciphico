...
namespace backend::lib {
    object int_(std::pmr::deque<std::shared_ptr<ast::tree>>&& args) noexcept {
        return args[0]->content.to_string();
    }
    object str_(std::pmr::deque<std::shared_ptr<ast::tree>>&& args) noexcept {
        return "\"" + args[0]->content.to_string() + "\"";
    }
    object getitem(std::pmr::deque<std::shared_ptr<ast::tree>>&& args) noexcept {
    ...
    object del_(std::pmr::deque<std::shared_ptr<ast::tree>>&& args) noexcept {
